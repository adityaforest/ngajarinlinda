...
func main() {
	...
	api := operations.NewNgajarinLindaAPI(swaggerSpec)
	...
	rt := ngajarinlinda.NewRuntime(cfg)
	...
	handler := alice.New(
		middlewares.NewRecoveryMW("ngajarinlinda", nil),
